            ...
            <div className="ser_s1">
                <div className="ser_s1_inner">
                    <div className="ser_s1_content">
                        ...
                        <h1 className="ser_s1_title">Search Engine Optimisation</h1>
                ...
                <div className="container">
                    <div className="ser_s2_frame">
                        <div className="ser_s2_left">
                            <h6 className="ser_s2_pre_title">What is SEO?</h6>
                        ...
                        <div className="ser_s2_right">
                            <h6 className="ser_s2_pre_title">Why is SEO Important?</h6>
                            <h1 className="ser_s2_title">
                                get to the top of the search
                            </h1>
                            <div className="ser_s2_bar"></div>
                            <p className="ser_s2_subtitle">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ullamcorper nunc hendrerit eget sed iaculis felis, quis viverra. Quisque donec purus ac amet fusce duis tellus facilisis pharetra. Imperdiet pellentesque nisl in tellus. Consectetur magnis at aliquet sed elementum. Pellentesque volutpat a vitae risus nunc et pharetra leo. Tristique sem mi porttitor morbi vel enim proin. Nisl ac neque, id euismod.
                                ...
                                <div className="tab-content" id="pills-tabContent">
                                    <div className="tab-pane fade show active service_contentmain" id="pills-one" role="tabpanel"
                                        ...
                                        <div className="service_tabcontent table-responsive">
                                            <table className="table table-borderless mb-0 service_table seo_table">
                                                <thead className="service_table_header">
                                                    <tr className="align-middle">
                                                        ...
                                                        <th scope="col" className="text-center">
                                                            <div className="social_tablehead">
                                                                <p className="social_tabletitle">Platinum</p>
                                                                <p className="social_tableamt">£980</p>
                                                                <p className="social_tablesubtitle">+VAT</p>
                                                                <button type="button" className="btn social_tablebtn">Add&nbsp;To&nbsp;Cart</button>
                                                            </div>
                                                        </th>
                                                        <th scope="col" className="text-center">
                                                            <div className="social_tablehead">
                                                                <p className="social_tabletitle">Diamond</p>
                                                                <p className="social_tableamt">£1355</p>
                                                                <p className="social_tablesubtitle">+VAT</p>
                                                                <button type="button" className="btn social_tablebtn">Add&nbsp;To&nbsp;Cart</button>
                                                            </div>
                                                        </th>
                                                        <th scope="col" className="text-center">
                                                            <div className="social_tablehead">
                                                                <p className="social_tabletitle">Master</p>
                                                                <p className="social_tableamt">£1355</p>
                                                                <p className="social_tablesubtitle">+VAT</p>
                                                                <button type="button" className="btn social_tablebtn">Add&nbsp;To&nbsp;Cart</button>
                                                            </div>
                                                ...
                                                <tbody className="service_table_body">
                                                    <tr className="align-middle">
                                                        <td>
                                                            <p className="service_bodytitle">Audits</p>
                                                        </td>
                                                    ...
                                                    <tr className="align-middle">
                                                        <td>
                                                            <p className="service_bodytitle">Blog / News Site Outreach</p>
                                                        </td>
                                                        <td className="text-center">
                                                            <Image src={tick} className="img-fluid" alt="" />
                                                        </td>
                                                    ...
                                                    <tr className="align-middle">
                                                        <td>
                                                            <p className="service_bodytitle">Blog Optimisation</p>
                                                        </td>
                                                        <td className="text-center">
                                                            <Image src={tick} className="img-fluid" alt="" />
                                                        </td>
                                                    ...
                                                    <tr className="align-middle">
                                                        <td>
                                                            <p className="service_bodytitle">Competitor Analysis</p>
                                                        </td>
                                                        <td className="text-center">
                                                            <Image src={tick} className="img-fluid" alt="" />
                                                        </td>
                                                    ...
                                                    <tr className="align-middle">
                                                        <td>
                                                            <p className="service_bodytitle">Content Optimisation</p>
                                                        </td>
                                                        <td className="text-center">
                                                            <Image src={tick} className="img-fluid" alt="" />
                                                        </td>
                                                    ...
                                                    <tr className="align-middle">
                                                        <td>
                                                            <p className="service_bodytitle">Daily Keyword Monitoring</p>
                                                        </td>
                                                        <td className="text-center">
                                                            <Image src={tick} className="img-fluid" alt="" />
                                                        </td>
                                                    ...
                                                    <tr className="align-middle">
                                                        <td>
                                                            <p className="service_bodytitle">Detailed Monthly Reports</p>
                                                        </td>
                                                        <td className="text-center">
                                                            <Image src={tick} className="img-fluid" alt="" />
                                                        </td>
                                                    ...
                                                    <tr className="align-middle">
                                                        <td>
                                                            <p className="service_bodytitle">Free Setup</p>
                                                        </td>
                                                        <td className="text-center">
                                                            <Image src={tick} className="img-fluid" alt="" />
                                                        </td>
                                                    ...
                                                    <tr className="align-middle">
                                                        <td>
                                                            <p className="service_bodytitle">Keyword Analysis</p>
                                                        </td>
                                                        <td className="text-center">
                                                            <Image src={tick} className="img-fluid" alt="" />
                                                        </td>
                                                    ...
                                                    <tr className="align-middle">
                                                        <td>
                                                            <p className="service_bodytitle">Link Building</p>
                                                        </td>
                                                        <td className="text-center">
                                                            <Image src={tick} className="img-fluid" alt="" />
                                                        </td>
                                                    ...
                                                    <tr className="align-middle">
                                                        <td>
                                                            <p className="service_bodytitle">Monthly Blog Post</p>
                                                        </td>
                                                        <td className="text-center">
                                                            <Image src={tick} className="img-fluid" alt="" />
                                                        </td>
                                                    ...
                                                    <tr className="align-middle">
                                                        <td>
                                                            <p className="service_bodytitle">National / International SEO</p>
                                                        </td>
                                                        <td className="text-center">
                                                            <p className="service_bodytext">National</p>
                                                        </td>
                                                        <td className="text-center">
                                                            <p className="service_bodytext">National</p>
                                                        </td>
                                                    ...
                                                    <tr className="align-middle">
                                                        <td>
                                                            <p className="service_bodytitle">No Contract, Cancel Anytime</p>
                                                        </td>
                                                        <td className="text-center">
                                                            <Image src={tick} className="img-fluid" alt="" />
                                                        </td>
                                                    ...
                                                    <tr className="align-middle">
                                                        <td>
                                                            <p className="service_bodytitle">Press Release Creation</p>
                                                        </td>
                                                        <td className="text-center">
                                                            <Image src={tick} className="img-fluid" alt="" />
                                                        </td>
                                                    ...
                                                    <tr className="align-middle">
                                                        <td>
                                                            <p className="service_bodytitle">Support, 7 Days a week</p>
                                                        </td>
                                                        <td className="text-center">
                                                            <Image src={tick} className="img-fluid" alt="" />
                                                        </td>
                                                    ...
                                                    <tr className="align-middle">
                                                        <td>
                                                            <p className="service_bodytitle">Technical Optimisation</p>
                                                        </td>
                                                        <td className="text-center">
                                                            <Image src={tick} className="img-fluid" alt="" />
                                                        </td>
                                                    ...
                                                    <tr className="align-middle">
                                                        <td>
                                                            <p className="service_bodytitle">Your Keyword / Phrase</p>
                                                        </td>
                                                        <td className="text-center">
                                                            <p className="service_bodytext">1</p>
                                                        </td>
                                                        <td className="text-center">
                                                            <p className="service_bodytext">3</p>
                                                        </td>
                                                        <td className="text-center">
                                                            <p className="service_bodytext">5</p>
                                                        </td>
                                                        <td className="text-center">
                                                            <p className="service_bodytext">10</p>
                                                        </td>
                                                        <td className="text-center">
                                                            <p className="service_bodytext">15</p>
                                                        </td>
                                                        <td className="text-center">
                                                            <p className="service_bodytext">2/5</p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
